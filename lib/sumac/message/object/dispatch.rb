    ...
    class Object
      module Dispatch
        ...
        def self.from_json_structure(connection, json_structure)
          ...
          when 'exception'
            Exception.from_json_structure(connection, json_structure)
          when 'native_exception'
            NativeException.from_json_structure(connection, json_structure)
          when 'integer'
        ...
        def self.from_native_object(connection, native_object)
          ...
          when Exception.map.rassoc(native_object.class) != nil
            Exception.from_native_object(connection, native_object)
          when native_object.kind_of?(Exception)
            NativeException.from_native_object(connection, native_object)
